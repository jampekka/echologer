(() => {
  ...
  // index.coffee
  var require_echologer = __commonJS({
    "index.coffee"(exports) {
      (function() {
        var $, EchoSource, mediaDevices, speed_of_sound, start;
        $ = require_jquery();
        speed_of_sound = 331;
        EchoSource = function(ctx, pos, decayTime) {
          var delay, dx, dy, dz, listener, panner;
        ...
        start = async function() {
          var ctx, echo, mic, mic_dev, mic_raw, output, sources;
          console.log("Stating");
